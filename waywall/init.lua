...
local nb_path = home_path .. ".minecraft/Ninjabrain-Bot-1.5.1.jar"
...
--     tall = make_res(340, 16384, tall_enable, res_disable),
    tall = make_res(340, 8192, tall_enable, res_disable),
