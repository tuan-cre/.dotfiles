...
MANIFEST_SRC="$HOME/.config/memes/me.memes.collection.json"
HOST_SCRIPT="$HOME/.config/memes/meme-native-host"
EXTENSION_DIR="$HOME/.config/memes/meme-browser"
...
chmod +x "$HOST_SCRIPT"
echo "✅ Native host script ready: $HOST_SCRIPT"
...
echo "✅ Firefox native messaging registered"
...
echo "  5. Verify no errors show up"
echo ""
echo "Firefox:"
echo "  1. Open about:debugging#/runtime/this-firefox"
echo "  2. Click 'Load Temporary Add-on'"
echo "  3. Select: $EXTENSION_DIR/manifest.json"
echo "  4. For permanent install, see about:addons → gear icon → Install Add-on From File"
echo ""
echo "━━━ Usage ━━━"
